...
from src.data_loader import build_quality_reports, load_all_provinces
from src.reporting import write_insights, write_markdown_summary, write_quality_summary
from src.runtime_config import load_runtime_config
from src.visualization import plot_heatmaps_by_target, plot_province_variability, plot_top_relationships
...
def run_pipeline(config_path: str) -> None:
    ...
    data_folder = cfg.resolve_path(cfg.paths.get("data_folder", "../../data/raw"))
    output_dir = cfg.resolve_path(cfg.paths.get("output_dir", "../outputs"))
    out_dirs = ensure_output_dirs(output_dir)

    print(f"[INFO] Loading data from: {data_folder}")
    df = load_all_provinces(data_folder, province_col=params.province_col)
    ...
    from src.visualization import plot_heatmaps_by_target_mi
